...
document.querySelector(".navigation__themeSwitcher").addEventListener("mouseup", switchTheme);

function getCountries() {
  _http.http.get("https://restcountries.eu/rest/v2/all").then(function (data) {
    _ui.ui.showCountries(data);
      ...
      country.addEventListener("click", function (e) {
        ...
        data.forEach(function (dat) {
          if (country.name === dat.name) {
            showDetailsPage();
            _ui.ui.showDetails(dat, data);
            _ui.ui.getBorders(data, dat);
          }
        });
    ...
    var selectRegion = document.querySelector(".form__group--select");
    _ui.ui.showRegions(data);
    selectRegion.addEventListener("click", function () {
      var regions = document.querySelector(".form__group--items");
      regions.classList.toggle("showRegion");
    });
    //End of displaying the region
  }).catch(function (err) {
    _ui.ui.showError(err);
  });
}

function switchTheme() {
  //Navigation
  var icon = document.querySelector(".navigation__switcher--img use");
  var formIcon = document.querySelector(".form__group--icon");
  var themeSwitch = document.querySelector(".navigation__themeSwitcher");
  var formGroup = document.querySelectorAll(".form__group");

  //Body
  var body = document.querySelector("body");
  var nav = document.querySelector(".navigation");
  var content = document.querySelectorAll(".countries__content");

  //Details Page
  var backBtn = document.querySelector(".back__btn--link");
  var detailText = document.querySelector(".details__items");
  var borders = document.querySelector(".details__items--countries");
  ...
  formGroup.forEach(function (grp) {
...
var UI = function () {
  function UI() {
    ...
    this.formatNumbersWithComma = function (num) {
  ...
  _createClass(UI, [{
    key: "showCountries",
    value: function showCountries(countries) {
      var _this = this;
      ...
      countries.forEach(function (country) {
        ...
        population = _this.formatNumbersWithComma(population);
    ...
    key: "showDetails",
    value: function showDetails(detail) {
      event.preventDefault();
      var output = "";

      var population = detail.population;
      population = this.formatNumbersWithComma(population);

      output = "\n      <div class=\"details__items--img\">\n        <img src=\"" + detail.flag + "\" alt=\"Flag\">\n      </div>\n      <div class=\"details__items--texts\">\n        <h2 class=\"details__items--heading\">" + detail.name + "</h2>\n\n        <ul class=\"details__items--details\">\n          <li class=\"details__items--detail\"><strong>Native Name: </strong>" + detail.nativeName + "</li>\n          <li class=\"details__items--detail\"><strong>Population: </strong>" + population + "</li>\n          <li class=\"details__items--detail\"><strong>Region: </strong>" + detail.region + "</li>\n          <li class=\"details__items--detail\"><strong>Sub Region: </strong>" + detail.subregion + "</li>\n          <li class=\"details__items--detail\"><strong>Capital: </strong>" + detail.capital + "</li>\n          <li class=\"details__items--detail\"><strong>Top Level Domain: </strong>" + detail.topLevelDomain + "</li>\n          <li class=\"details__items--detail\"><strong>Currencies: </strong>" + detail.currencies.map(function (c) {
        return c.name;
      }).join(", ") + "</li>\n          <li class=\"details__items--detail\"><strong>Languages: </strong>" + detail.languages.map(function (l) {
        return l.name;
      }).join(", ") + "</li>\n        </ul>\n\n        <div class=\"details__items--countries\">\n            <p class=\"details__items--country-text\"><strong>Border Countries: </strong></p>\n            <ul class=\"details__items--country-items\">\n              " + detail.borders.map(function (b) {
        return "<li class=\"details__items--country-item\">" + b + "</li>";
      }).join("") + "\n            </ul>\n        </div>\n      </div>\n     ";
    ...
    key: "getBorders",
    value: function getBorders(data, dat) {
      var _this2 = this;

      var b = document.querySelectorAll(".details__items--country-item");
      b.forEach(function (x) {
        return x.addEventListener("click", function (e) {
          e.preventDefault();
          data.forEach(function (d) {
            if (x.textContent === d.alpha3Code) {
              _this2.showDetails(d);
              _this2.getBorders(data, dat);
            }
          });
        });
      });
    ...
    value: function showRegions() {
      ...
      regions.forEach(function (region) {
        region.addEventListener("click", function () {
          var countries = document.querySelectorAll(".countries__content");
          var dropDown = _this3.regionList;
